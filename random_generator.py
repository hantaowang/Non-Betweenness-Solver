...
# Generates numConstraints random constraints with at least
# one for each wizard
def makeConstraints(wizards, numConstraints):
    constraints = []
...
if __name__ == "__main__":
    ...
    constraints = makeConstraints(wizards, numConstraints)
    f = open('{0}.in'.format(sys.argv[3]),'w+')
